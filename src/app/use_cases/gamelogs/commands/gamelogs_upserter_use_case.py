from domain.entities import PlayerEntity, GamelogEntity
from interfaces.repositories import IGamelogRepository
from interfaces.external import IGamelogsFetcher
...
class GamelogsUpserterUseCase:
    ...
    def execute(self, season: int | None) -> None:
        """
        ...
        for gamelog in gamelogs:
            self.gamelog_repository.upsert(gamelog)
