...
class PlayersFetcher(IPlayersFetcher):
    """
    Fetches NBA players and their relevant data.
        ...
        for nba_api_player in nba_api_players:
            try:
                ...
                player_entity = PlayerEntity(
                    playerId=int(nba_api_player[0]),
                    rotowireId=sleeper_api_player["rotowire_id"],  # Fantasy news provider.
